 ...
 * It produces track residuals as default output and includes an optional KFParticle
 * setup, with the default configuration aimed at K0_S reconstruction.
 *
 * Originally developed by Anthony Frawley.
 * Later modified and extended by Pedro Nieto for:
 *   - K0_S reconstruction
...
void Fun4All_TrackSeeding(
    const int runnumber = 79507,
    const int segment = 0,
    const int nEvents = -1,
    const char* caloFile = "lists/DST_CALOFITTING_79507.list",
    const std::string &clusterfilename = "DST_TRKR_CLUSTER_run3pp_ana532_2025p009_v001-00079507-00000.root",
    const std::string &dir = "/sphenix/lustre01/sphnxpro/production/run3pp/physics/ana532_2025p009_v001/DST_TRKR_CLUSTER/run_00079500_00079600/",
