...
class FastDecayReco : public SubsysReco
{
 public:
  FastDecayReco(const std::string& name = "FastDecayReco");
  virtual ~FastDecayReco() = default;
 ...
 // std::vector<TCanvas*> m_debug_canvases;
  ...
  std::string m_output_trackMap_node_name {"FastDecayReco_SvtxTrackMap"};
};
